...
def main():
    ...
    ax.scatter(xs[0][0], ys[0][0], c='#e590a2')
    ax.scatter(xs[0][1], ys[0][1], c='#DFE0F6')
    ax.scatter(xs[0][2], ys[0][2], c='#D6FEED')
    ax.scatter(xs[0][3], ys[0][3], c='#F9EFC0')
    ax.scatter(xs[1][0], ys[1][0], c='#F19cAA')
    ax.scatter(xs[1][1], ys[1][1], c='#A3A7E5')
    ax.scatter(xs[1][2], ys[1][2], c='#70FFC1')
    ax.scatter(xs[1][3], ys[1][3], c='#F9E381')
    ax.scatter(xs[2][0], ys[2][0], c='#EB6F84')
    ax.scatter(xs[2][1], ys[2][1], c='#676FD4')
    ax.scatter(xs[2][2], ys[2][2], c='#00EF87')
    ax.scatter(xs[2][3], ys[2][3], c='#F9DD5C')
    ax.scatter(xs[3][0], ys[3][0], c='#E22C4A')
    ax.scatter(xs[3][1], ys[3][1], c='#353FBC')
    ax.scatter(xs[3][2], ys[3][2], c='#00A45D')
    ax.scatter(xs[3][3], ys[3][3], c='#F9CD04')
