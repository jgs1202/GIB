...
if argvs[1] == 'all':
    ...
    output.append('../../forceInABox/data/STGIB/comp/')
    output.append('../../forceInABox/data/Chaturvedi/comp/')
    output.append('../../forceInABox/data/TRGIB/comp/')
    output.append('../../forceInABox/data/FDGIB/comp/')
    layout.append('STGIB')
